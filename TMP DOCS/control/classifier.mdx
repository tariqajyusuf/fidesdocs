...
![Classify a Dataset](/assets/img/enterprise/classify_dataset.png)
...
![Classification In Progress](/assets/img/enterprise/classify_inprogress.png)
...
![Classification Results](/assets/img/enterprise/classify_results.png)
...
![Classification Review](/assets/img/enterprise/classify_review.png)

You are now ready to approve your results by selecting **Approve dataset classification**, and move on to the next dataset.

![Classification Status](/assets/img/enterprise/classify_status.png)
