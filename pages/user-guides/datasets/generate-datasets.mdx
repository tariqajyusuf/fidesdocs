...
* [Annotating datasets with data categories and key relationships](annotate-datasets#adding-an-identity-key)
...
<Callout emoji="" type="info">You can also create a new dataset using the _dataset editor_ when creating an integration. Learn more in our guide for [Linking datasets](link-datasets).</Callout> 
...
<Callout emoji="ⓘ">**Note:** Licensed users can optionally classify their dataset in this step. Learn more in our guide for [Classifying datasets](classify-datasets)</Callout>

For more details and examples, please see our guide for [Generating resources](/dev-docs/cli/manage/cmd-generate).