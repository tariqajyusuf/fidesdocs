...
* [Annotating datasets with data categories and key relationships](/user-guides/datasets/annotate-datasets#adding-an-identity-key)
...
<Callout emoji="" type="info">You can also create a new dataset using the _dataset editor_ when creating an integration. Learn more in our guide for [Linking datasets](/user-guides/datasets/link-datasets).</Callout> 
