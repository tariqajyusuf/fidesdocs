...
To upload this file to Fides, please follow these steps: [Uploading a dataset](/docs/user-guides/datasets/generate-datasets#uploading-a-dataset)
...
To learn more about advanced coniguration options and how Fides traverses databases, please see our guide for [Query execution](/docs/dev-docs/configuration/privacy-requests/graphs)
