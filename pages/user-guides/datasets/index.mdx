...
### Linking datasets
To process privacy requests against databases, a dataset must be generated, annotated, and linked to the [database integration](./integrations).  Learn more in our guide for [Linking datasets](/user-guides/datasets/link-datasets).
