...
![Create a dataset](../../../public/assets/img/integrations/create-datasets.gif)
...
![Link a dataset](../../../public/assets/img/integrations/link-datasets.gif)

<Callout emoji="ⓘ"> We will be publishing developer-focused docs for supporting integrations and datasets using the API shortly - stay tuned! </Callout>
