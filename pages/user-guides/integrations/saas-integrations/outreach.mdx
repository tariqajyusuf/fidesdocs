...
In order to [integrate](../) with Outreach, you'll need to setup a custom Outreach app using OAuth 2.0 for authentication. To learn more about how to set this up, please see the [Outreach docs](https://developers.outreach.io/client-extensions/your-first-outreach-extension/). 
