...
| Name                  | Description                                                                                                                                           |
| :-------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Domain\***          | The domain (default api.gong.io)                                                                                                                              |
| **Gong Basic Token\*** | A token is created by combining the Access Key and Access Key Secret, more details here [Authentication](https://us-66708.app.gong.io/settings/api/documentation#overview) docs to learn more. |
