...
[Typeform](https://www.typeform.com/) is a suite of research tools that help provide insight from visitors, customers, and users.

## Prerequisites

In order to [integrate](../) with Typeform, you'll need to collect the following information:

| Name                      | Description                                                                                                                                                                         |
| :------------------------ | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Domain\***              | The domain (default: api.typeform.com)                                                                                                                                              |
| **Typeform API Key\***    | The API access token. Follow Typeform's [Personal access token for Typeform's APIs](https://www.typeform.com/developers/get-started/personal-access-token/) docs to learn more.     |
| **Typeform Account ID\*** | The Account ID can be found by reviewing the URL of your instance. [Typeform account_id Parameter](https://community.typeform.com/typeform-developers-44/account-id-parameter-4027) |

## Integrating with Typeform

To integrate an existing system with Typeform:
