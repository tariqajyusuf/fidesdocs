...
| **Redirect URL\** | The Fides URL to which users will be redirected upon successful authentication 
...
| --------------------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| **(RTBF) Delete responses** | [Right To Be Forgotten](https://www.typeform.com/developers/responses/reference/rtbf-delete-responses/) | Delete responses that contain an email from a specified list |
