...
If you are connecting to a database, you will need to create a [_dataset_](/dev-docs/datasets) in order to process Data Subject Requests (DSRs).  For detailed steps, please see our guide for [Linking datasets](/dev-docs/privacy-requests/datasets/link-datasets).
