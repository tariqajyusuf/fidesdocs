...
To learn more about _Integrations_ are and to see which vendors we currently support, please see the [Overview](/docs/user-guides/integrations).
...
* [SaaS vendor guides](/docs/user-guides/integrations/saas-integrations/)
* [Database vendor guides](/docs/user-guides/integrations/databases/)
...
If you are connecting to a database, you will need to create a [_dataset_](/docs/user-guides/datasets) in order to process Data Subject Requests (DSRs).  For detailed steps, please see our guide for [Linking datasets](/docs/user-guides/datasets/link-datasets).
