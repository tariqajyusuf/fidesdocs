...
To learn more about _Integrations_ are and to see which vendors we currently support, please see the [Overview](/user-guides/integrations).
...
If you are connecting to a database, you will need to create a [_dataset_](/user-guides/datasets) in order to process Data Subject Requests (DSRs).  For detailed steps, please see our guide for [Linking datasets](/user-guides/datasets/link-datasets).
