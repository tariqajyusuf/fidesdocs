...
<KeyFeatWrap>
  <KeyFeat link="./consent/consent-laws" title="Where do Consent Laws Apply?"/>
  <KeyFeat link="./consent/consent-laws" title="What are the typs of Consent?"/>
  <KeyFeat link="./consent/consent-user-experience" title="What is the right user experience for consent?"/>
  <KeyFeat link="./consent/consent-vs-prefs" title="Difference between consent and preferences?"/>
  <KeyFeat link="./consent/consent-signals" title="What are Consent Signals?"/>
  <KeyFeat link="./consent/consent-records" title="What are Consent Records?"/>
  <KeyFeat link="./consent/consent-iab-tcf" title="What is the IAB TCF?"/>
  <KeyFeat link="./consent/consent-iab-tcf-ca" title="What is the IAB TCF Canada?"/>
  <KeyFeat link="./consent/consent-iab-usp" title="What is IAB USPrivacy?"/>
  <KeyFeat link="./consent/consent-iab-gpp" title="What is IAB Global Privacy Platform (GPP)?"/>
  <KeyFeat link="./consent/consent-iab-mspa" title="What is IAB Multi-State Privacy Agreement (MSPA)?"/>
  <KeyFeat link="./consent/consent-iab-gpp" title="What is Global Privacy Control (GPC)?"/>
</KeyFeatWrap>
