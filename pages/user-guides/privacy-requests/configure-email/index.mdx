...
For steps to update the _content_ of these messages, please see our guide for [configuring email content](./configure-email/email-content).

For steps to update the _style_ of these messages, please see our guide for [configuring email style](./configure-email/email-style).
