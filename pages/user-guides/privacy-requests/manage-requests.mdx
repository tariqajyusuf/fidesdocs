...
<Screenshot img="/docs/assets/img/tutorials/privacy-requests-admin.gif" description="Fides Control Privacy Request Review Panel" />
...
<Screenshot img="/docs/assets/img/tutorials/privacy-requests-view-details.gif" description="View Privacy Request Details" mw="500"/>
...
<Screenshot img="/docs/assets/img/tutorials/privacy-requests-details.gif" description="Privacy Request Details Page"/>
...
<Screenshot img="/docs/assets/img/tutorials/privacy-requests-dates.gif" description="Filter Privacy Requests by Date Range" mw="420" />

Each privacy request is assigned a uniquely identifiable **Request ID** and you can search for the request using this ID:

<Screenshot img="/docs/assets/img/tutorials/privacy-requests-search.gif" description="Search for Privacy Request by ID" mw="500" />

### Reporting
To download a report of the currently filtered view of privacy requests click the **Download** button.

<Screenshot img="/docs/assets/img/tutorials/privacy-requests-download.gif" description="Download Privacy Request Report" mw="500" />
...
<Screenshot img="/docs/assets/img/tutorials/privacy-requests-toggle-pii.gif" description="Toggle on PII" mw="500" />
