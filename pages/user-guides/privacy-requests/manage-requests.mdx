...
Once privacy requests have been [submitted](/docs/user-guides/privacy-requests/submit-requests) and [received](/docs/user-guides/privacy-requests/receive-requests), they must be reviewed. 
...
<Screenshot img="/assets/img/docs/docs/tutorials/privacy-requests-admin.gif" description="Fides Control Privacy Request Review Panel" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/privacy-requests-approve.gif" description="Approve Privacy Request" mw="550"/>

If a request has been **approved**, the data subject will be notified by email. If the request is an [_access_](/docs/docs/tutorials/privacy-requests-glossary#access-request) request, the confirmatiom email will include a download link to retrieve a copy of their personal data.
...
<Screenshot img="/assets/img/docs/docs/tutorials/privacy-requests-view-details.gif" description="View Privacy Request Details" mw="500"/>
...
<Screenshot img="/assets/img/docs/docs/tutorials/privacy-requests-details.gif" description="Privacy Request Details Page"/>
...
<Screenshot img="/assets/img/docs/docs/tutorials/privacy-requests-dates.gif" description="Filter Privacy Requests by Date Range" mw="420" />

Each privacy request is assigned a uniquely identifiable **Request ID** and you can search for the request using this ID:

<Screenshot img="/assets/img/docs/docs/tutorials/privacy-requests-search.gif" description="Search for Privacy Request by ID" mw="500" />

### Reporting
To download a report of the currently filtered view of privacy requests click the **Download** button.

<Screenshot img="/assets/img/docs/docs/tutorials/privacy-requests-download.gif" description="Download Privacy Request Report" mw="500" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/privacy-requests-toggle-pii.gif" description="Toggle on PII" mw="500" />
