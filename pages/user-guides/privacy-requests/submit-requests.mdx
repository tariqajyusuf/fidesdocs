...
To exercise these rights, data subjects typically submit a [_privacy request_](/tutorials/privacy-requests-glossary#privacy-request).
...
Fides provides the Privacy Center for your subjects to submit privacy requests. The Privacy Center works out-of-the-box but, to learn how to customize the Privacy Center, please read our guide for [configuring the Privacy Center](receive-requests#the-privacy-center).
...
If [Subject Identity Verification](privacy-requests/receive-requests#subject-identity-verification) is enabled, the data subject will receive an authentication code that they can use to confirm their identity.
...
Next up: [Receiving privacy requests](receive-requests)!
