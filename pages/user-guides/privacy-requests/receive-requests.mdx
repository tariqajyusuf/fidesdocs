...
Ethyca recommends using Multi-Factor Authentication (MFA) for identify verification and Fides offers built-in Subject Identity Verifiation using MFA. To learn more, please see our guide for configuring [Subject Identity Verification](/docs/dev-docs/configuration/privacy-requests/subject-identity-verification). 
...
* [Set a custom Title, Description, or Logo](/docs/dev-docs/configuration/privacy-requests/privacy-center#set-custom-fields)
* [Use a CSS Stylesheet](/docs/dev-docs/configuration/privacy-requests/privacy-center#configure-website-appearance)

To configure which privacy request functions appear in your Privacy Center, please follow our guide for [Configuring privacy request functions](/docs/dev-docs/configuration/privacy-requests/privacy-center#configure-privacy-request-options).
