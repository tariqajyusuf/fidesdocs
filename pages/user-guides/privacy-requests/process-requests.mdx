...
1. [Generate a dataset](/dev-docs/privacy-requests/datasets/generate-datasets) 
2. [Annotate the dataset with data categories](/dev-docs/privacy-requests/datasets/annotate-datasets#annotating-data-categories)
3. [Establish which fields contain identities](/dev-docs/privacy-requests/datasets/annotate-datasets#annotating-data-categories#adding-an-identity-key)
