...
### Troubleshooting
To learn how to debug common issues with API-based privacy requests, please see our guide for [Identifying & debugging issues](/docs/docs/tutorials/privacy-requests-debugging)
...
## Manual requests
Manual privacy requests allow vendors to upload personal data using an API to satisfy [Access](/docs/docs/tutorials/privacy-requests-glossary#access-request) requests. To enable these requests, a `manual process` integration must be configured.
...
When an [access](/docs/docs/tutorials/privacy-requests-glossary#access-request) request is placed, a package containing the found personal data is returned. In order to properly format this package, you'll need to tell Fides how to label the fields of personal data in it. 
...
## Manual requests
Manual privacy requests allow vendors to upload personal data using the API to satisfy an [_Access_](/docs/docs/tutorials/privacy-requests-glossary#access-request) request. To enable these requests,`manual process` connection must be created.
