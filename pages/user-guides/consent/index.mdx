...
<KeyFeatWrap>
  ...
  <KeyFeat link="/docs/user-guides/consent/consent-iab-tcf-ca" title="What is the IAB TCF Canada?"/>
...
To get started configuring consent watch the in-depth [consent tutorial](/docs/docs/tutorials/consent-management-get-started) here or watch the video below:
