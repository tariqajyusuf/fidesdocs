...
- To learn how to style your code, see the [style guide](/docs/community/development/code_style).
- To learn how to migrate the database schema, see the [database migration guide](/docs/community/development/database_migration).
- To learn how to document your code, see the [docs guide](/docs/community/development/documentation).
- To learn how to test your code, see the [tests guide](/docs/community/development/testing).
- To learn what format your PR should follow, make sure to follow the [pull request guidelines](/docs/community/development/pull_requests).
