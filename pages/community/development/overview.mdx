...
<NextSeo
  ...
  description="A concise introduction to our project's objectives, structure, and its unique place within the tech ecosystem."
/>
...
- To learn how to style your code, see the [style guide](/community/development/code_style).
- To learn how to migrate the database schema, see the [database migration guide](/community/development/database_migration).
- To learn how to document your code, see the [docs guide](/community/development/documentation).
- To learn how to test your code, see the [tests guide](/community/development/testing).
- To learn what format your PR should follow, make sure to follow the [pull request guidelines](/community/development/pull_requests).
