...
<NextSeo
  ...
  description="Streamline your debugging process in JetBrains IDEs with practical advice tailored to our project’s framework and design."
/>
...
![Screenshot of IDE Docker setup](/assets/img/docker.png)
...
![Screenshot of Add Python Interpreter](/assets/img/docker.png)

![Screenshot of Project Structure SDKs](/assets/img/SDKs.png)
...
![Screenshot of Run/Debug Configuration for main.py](/assets/img/debug_config.png)
...
![Screenshot of Debugging from IntelliJ](/assets/img/debugging.png)
