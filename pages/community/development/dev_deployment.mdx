...
<NextSeo
  ...
  description="Step-by-step guide on setting up a robust development deployment that aligns with our project's configurations."
/>

# Fides Deploy Development

This guide closely mirrors the [advanced deployment guide](/dev-docs/get-started/advanced) page with some slight differences to account for running in a development environment.
