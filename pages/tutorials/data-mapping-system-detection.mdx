...
<Screenshot img="/assets/img/tutorials/data-mapping-scan-sso-results.gif" description="Single sign-on provider scanner results of discovered systems" />
...
<Screenshot img="/assets/img/tutorials/data-mapping-scan-dataflow-results.gif" description="Network data flow scanner results of discovered systems" />
