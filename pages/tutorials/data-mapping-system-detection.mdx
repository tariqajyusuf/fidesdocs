...
* Adequatedly scoped credentials for the scan target, such as Cloud Provider or Single Sign-On Provider. 
...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-scan-infrastructure.gif" description="Scan your cloud to detect systems" />
...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-scan-infrastructure-authenticate.gif" description="Authenticate the infrastructure scanner" />
...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-scan-infrastructure-results.gif" description="Infrastructure scanner results of disovered systemss" />
...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-scan-sso.gif" description="Scan your single sign-on provider to detect systems" />
...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-scan-sso-authenticate.gif" description="Authenticate the sign sign-on provider scanner" />
...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-scan-sso-results.gif" description="Single sign-on provider scanner results of disovered systems" />
...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-scan-dataflow.gif" description="Scan your network data flows to detect systems" />
...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-scan-dataflow-results.gif" description="Network data flow scanner results of disovered systems" />
...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-scan-dataflow-classification-results.gif" description="Machine learning sensitive data flow classification awaiting review" />
...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-scan-dataflow-classification-detail-results.gif" description="Machine learning sensitive data flow classification awaiting review" />
