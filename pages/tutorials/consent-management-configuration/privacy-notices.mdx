...
After reading this, you'll be familiar with how data uses from the [previous section](/docs/docs/tutorials/consent-management-configuration/data-use-for-consent) automatically generate privacy notices, as well as how to create and manage your own custom privacy notices.
...
Learn more about [privacy notice fundamentals](/docs/docs/tutorials/consent-management-fundamentals/consent-management-privacy-notices) here.
...
<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-privacy-notices.gif" description="View all Privacy Notices" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-new-notice.gif" description="Create a Privacy Notices" mw="450" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-privacy-notice-details.gif" description="Privacy Notice Details" mw="500" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-consent-mechanism-consent.gif" description="Privacy Notice Consent Mechanism" mw="500" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-consent-mechanism-enforcement.gif" description="Privacy Notice Consent Enforcement" mw="500" />

#### GPC Signal
Toggle whether this privacy notice should conform and respond to the Global Privacy Control. Learn more about the [Global Privacy Control](/docs/regulations/gpc/overview) here.

<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-consent-mechanism-gpc.gif" description="Privacy Notice GPC Configuration" mw="500" />
...
You can configure the data uses associated with the privacy notice. Typically, Fides relies on the default data uses but you can add to these at any time. Read about [modifying data uses in the taxonomy](/docs/docs/tutorials/consent-management-configuration/data-use-for-consent) here.

<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-config-data-use.gif" description="Privacy Notice Configure Data Uses" mw="500" />

#### Description
Allows you to set a description of the data notice **only visible to internal users** of your organization.

<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-config-description.gif" description="Privacy Notice Configure Description" mw="500" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-config-location.gif" description="Privacy Notice Configure Locations" mw="500" />
...
The **cookie key** is used to identify the visitors preferences for the specific privacy notice. For example, if a visitor opted out of Data Sales and Sharing, the cookie on their browser would have the value: `data_sales_and_sharing` set to `false`. Learn how to [configure front end consent](/docs/docs/tutorials/consent-management-configuration) here.

<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-config-cookie-key.gif" description="Privacy Notice Configure Cookie Key" mw="500" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-config-privacy-experience.gif" description="Privacy Notice Configure Privacy Experience" mw="500" />
