...
2. **Consent Mechanism**: the method of consent for this privacy noice.
...
You can configure teh data uses associated with the privacy notice. Typically, Fides relies on the default data uses but you can add to these at any time. Read about [modifying data uses in the taxonomy](#LINK) here.
