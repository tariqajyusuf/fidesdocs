...
In this tutorial we will review how to configure the Global Privacy Contorl (GPC)
...
Navigate to the configuration to toggle whether this privacy notice should conform and respond to the Global Privacy Control. Learn more about the [Global Privacy Control](/regulations/gpc/overview) here.
