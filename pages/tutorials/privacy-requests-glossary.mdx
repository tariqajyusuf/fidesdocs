...
<TutorialKey duration="4" product="Fides" topic="Privacy Request Glossary"/>

This page collects brief definitions of some of the common terms used for Privacy Requests and Fides.
For a full glossary of data privacy and governance terms, as well as some terms that come up frequently in conversations throughout the Fides community read the full [Fides Data Privacy Glossary](#LINK) now.
