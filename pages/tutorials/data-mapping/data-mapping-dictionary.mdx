...
<Screenshot img="/docs/assets/img/tutorials/data-mapping/data-mapping-dictionary-add-system.gif" description="Use dictionary when adding system" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping/data-mapping-dictionary-update-systems.gif" description="Use dictionary when updating systems" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping/data-mapping-dictionary-add-data-uses.gif" description="Add data uses" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping/data-mapping-dictionary-data-uses-override.gif" description="Add data uses" />


Next you will learn to visualize, [filter and build reports such as a RoPA (Record of Processing Activities)](/tutorials/data-mapping/data-mapping-reports).
