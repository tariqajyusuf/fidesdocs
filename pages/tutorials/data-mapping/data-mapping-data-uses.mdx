...
<Callout emoji="" type="info">If you're a Fides Enterprise customer, you can use our built-in privacy dictionary, Fides Compass, to pre-populate system info and data use information. Learn more at [Fides Privacy Dictionary](/tutorials/data-mapping/data-mapping-dictionary)</Callout>
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping/data-mapping-data-use-creation.gif" description="Add data uses" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping/data-mapping-data-use-configure.gif" description="Add data uses" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping/data-mapping-data-use-special-category.gif" description="Add data uses" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping/data-mapping-data-use-third-parties.gif" description="Add data uses" />



Next you will learn how to accelerate data entry by using [Fides Compass, a privacy intelligence dictionary](/tutorials/data-mapping/data-mapping-dictionary).