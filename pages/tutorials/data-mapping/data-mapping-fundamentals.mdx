...
First you should identify all systems. You can do this by either [manually adding them to your data map](/tutorials/data-mapping/data-mapping-adding-systems-manually), or using [Fides' Detection tools to automatically identify systems](/tutorials/data-mapping/data-mapping-system-detection).
