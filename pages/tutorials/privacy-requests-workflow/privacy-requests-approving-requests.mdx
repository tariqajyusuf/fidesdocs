...
When the request is complete, the subject will be notified by confirmation email. Where this is an access request, the email will include a download link to retrieve a copy of their personal data.
