...
<Callout emoji="" type="info">If you're a Fides Enterprise customer, you can use our built-in privacy dictionary, Fides Compass, to pre-populate system info and data use information. Learn more at [Fides Privacy Dictionary](/docs/docs/tutorials/data-mapping-dictionary)</Callout>
...
<Screenshot img="/assets/img/docs/docs/tutorials/data-mapping-data-use-creation.gif" description="Add data uses" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/data-mapping-data-use-configure.gif" description="Add data uses" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/data-mapping-data-use-special-category.gif" description="Add data uses" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/data-mapping-data-use-third-parties.gif" description="Add data uses" />



Next you will learn how to accelerate data entry by using [Fides Compass, a privacy intelligence dictionary](/docs/docs/tutorials/data-mapping-dictionary).