...
<Screenshot img="/docs/assets/img/tutorials/data-mapping-data-use-creation.gif" description="Add data uses" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping-data-use-configure.gif" description="Add data uses" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping-data-use-special-category.gif" description="Add data uses" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping-data-use-third-parties.gif" description="Add data uses" />
