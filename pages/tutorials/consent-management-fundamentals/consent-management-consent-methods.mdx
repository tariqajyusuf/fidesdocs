...
<Screenshot img="/docs/assets/img/tutorials/consent-management-optin-optout.gif" description="Consent Management - Opt-in vs. Opt-out" mw="400" />
...
<Screenshot img="/docs/assets/img/tutorials/consent-management-newsletter-optin.gif" description="Consent Management - Opt-in Example" mw="350" />
...
<Screenshot img="/docs/assets/img/tutorials/consent-management-datasharing-optout.gif" description="Consent Management - Opt-out Example" mw="350" />
