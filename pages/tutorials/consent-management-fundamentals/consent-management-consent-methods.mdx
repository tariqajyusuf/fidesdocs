...
<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-optin-optout.gif" description="Consent Management - Opt-in vs. Opt-out" mw="400" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-newsletter-optin.gif" description="Consent Management - Opt-in Example" mw="350" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/consent-management-datasharing-optout.gif" description="Consent Management - Opt-out Example" mw="350" />
