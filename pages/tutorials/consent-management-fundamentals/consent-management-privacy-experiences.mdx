...
<Screenshot img="/docs/assets/img/tutorials/consent-management-banner.gif" description="Consent Management - Opt-in Banner" />
...
<Screenshot img="/docs/assets/img/tutorials/consent-management-popup.gif" description="Consent Management - Opt-in Popup" mw="420"/>
...
<Screenshot img="/docs/assets/img/tutorials/consent-management-dns-link.gif" description="Consent Management - Do Not Sell or Share My Personal Information" />
...
<Screenshot img="/docs/assets/img/tutorials/consent-management-privacy-center.gif" description="Consent Management - Privacy Center" mw="550" />
