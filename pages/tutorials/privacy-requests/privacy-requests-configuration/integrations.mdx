...
## Introduction
In this tutorial, you'll add and configure a privacy request integration for a system on the [Data Map.](/tutorials/data-mapping) By the end of this tutorial, you'll understand the relationship between systems and integrations as well as how to connect, configure, and test an integration.
...
<Screenshot img="/docs/assets/img/tutorials/privacy-requests/privacy-requests-select-integrations.gif" description="Select the integration for your system" />
...
<Screenshot img="/docs/assets/img/tutorials/privacy-requests/privacy-requests-default-fields.gif" description="Complete the default fields for the system integration" />
...
<Screenshot img="/docs/assets/img/tutorials/privacy-requests/privacy-requests-credentials.gif" description="Provide credentials for the system integration"/>
...
<Screenshot img="/docs/assets/img/tutorials/privacy-requests/privacy-requests-testing.gif" description="Provide credentials for the system integration"  mw="450" />
