...
<Screenshot img="/assets/img/docs/docs/tutorials/data-mapping-manual-create-system.gif" description="Add a system manually" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/data-mapping-manual-create-system-info.gif" description="Add system info" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/data-mapping-manual-create-system-properties.gif" description="Add system properties" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/data-mapping-manual-create-system-admin.gif" description="Add system administrative info" />

Next you will learn how to use [automated system discovery tools](/docs/docs/tutorials/data-mapping-system-detection). and then you will [describe the ways in which you use personal data in your system](/docs/docs/tutorials/data-mapping-data-uses).