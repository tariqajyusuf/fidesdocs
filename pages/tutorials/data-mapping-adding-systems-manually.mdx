...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-manual-add-system.gif" description="Add a system manually" />

### Search for or Create your System
From here you can search the list of available system templates:

<Screenshot img="../../../public/assets/img/tutorials/data-mapping-manual-search-system.gif" description="Search for system templates" />

Alternatively, to create a custom system, select **Create system** from upper right corner:

<Screenshot img="../../../public/assets/img/tutorials/data-mapping-manual-create-system.gif" description="Create a system manually" />
...
<Screenshot img="../../../public/assets/img/tutorials/data-mapping-manual-describe-system.gif" description="Complete your system information" />
