...
<Screenshot img="/docs/assets/img/tutorials/data-mapping-manual-create-system.gif" description="Add a system manually" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping-manual-create-system-info.gif" description="Add system info" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping-manual-create-system-properties.gif" description="Add system properties" />
...
<Screenshot img="/docs/assets/img/tutorials/data-mapping-manual-create-system-admin.gif" description="Add system administrative info" />

Next you will learn how to use [automated system discovery tools](/tutorials/data-mapping-system-detection). and then you will [describe the ways in which you use personal data in your system](/tutorials/data-mapping-data-uses).