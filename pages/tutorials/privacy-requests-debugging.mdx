...
<Screenshot img="/assets/img/docs/docs/tutorials/privacy-requests-event-logs.gif" description="Privacy Request Logs" mw="600" />
...
<Screenshot img="/assets/img/docs/docs/tutorials/privacy-requests-detailed-log.gif" description="Approve Privacy Request" />
