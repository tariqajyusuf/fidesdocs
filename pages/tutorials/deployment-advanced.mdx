...
<Callout emoji="!"> There is no reason to expose this database to the public internet as long as it will be accessible by your webserver.</Callout>
...
<Callout emoji="!"> There is no reason to expose this cache to the public internet as long as it will be accessible by your webserver.</Callout>
