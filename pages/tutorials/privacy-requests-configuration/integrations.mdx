...
Typically, these are API integrations to allow you to simplify and automate each request. For systems that do not have APIs and only accept privacy requests by email, Fides has an integration to automate email notifications to the vendor. Read about [automated email notifications](#LINK) here.
