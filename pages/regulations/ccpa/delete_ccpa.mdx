...
Similar to the right of access in [section eight](/regulations/ccpa/dsar_ccpa), above, the right to deletion requires the same broad steps with some additional considerations:
...
## 3. Delete their personal data from your systems
    ...
    **Note**: you may retain personal information that you require for other regulatory purposes. A good example of this is, if you’re a retailer, you might need to retain order history information and the consumer's state of residence in order to calculate tax nexus for reporting purposes.
    ...
    If you want lightning-fast, automated deletion requests with [Privacy Engineering Intelligence from Ethyca](https://ethyca.com/book-demo?utm_source=docs-site), get in touch now.
    </Callout>
