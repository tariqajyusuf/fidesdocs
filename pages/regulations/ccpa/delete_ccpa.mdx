...
Similar to the right of access in [section eight](./dsar_ccpa), above, the right to deletion requires the same broad steps with some additional considerations:
