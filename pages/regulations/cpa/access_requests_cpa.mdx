...
# CPA Step 02: Access Requests for CPA

Under CPA, your business must provide consumers with the ability to request access to their personal data and respond to their requests within 45 days. You may also request a 45-day extension for a legitimate reason or if a delay occurs in processing their request.
...
Need more help with Access Requests? Ask a question in the [Fides Slack Community](https://fid.es/join-slack).

For more information about how the Fides Privacy engineering and intelligence platform automates access requests, [get in touch now](https://ethyca.com/book-demo?utm_source=docs-site).
</Callout>
