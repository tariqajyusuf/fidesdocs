...
Based on your [configuration](../configuration/configuration), Fides can perform a number of other actions: 
...
| **Approve** | If configured, Fides will require a system administrator to [approve](configuration/configuration#execution) the request before proceeding. |
