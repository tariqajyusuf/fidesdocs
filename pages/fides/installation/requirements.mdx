...
Production deployments may require a **[storage destination](../dsr_quickstart/dsr_support/storage/)** to store the results of completed privacy requests and the [**Privacy Center**](../consent) can be deployed as a pre-built and customizable portal for receiving privacy requests.
