...
- **Fides Compass!** Fides Compass is a privacy dictionary that is used to autocomplete system and data use information to speed time to compliance. Learn more [here](/docs/docs/tutorials/data-mapping-dictionary).
...
- **System and data use form updates**: forms for system info and data use declarations have been updated with many new fields that are commonly required for reporting in regions like the EU. Learn more [here](/docs/docs/tutorials/data-mapping-adding-systems-manually) and [here](/docs/docs/tutorials/data-mapping-data-uses).
...
- **Canadian consent support**: Canadian regions have been added for use with consent notices and experiences. Learn more about configuring consent [here](/docs/docs/tutorials/consent-management-configuration).
- **Datasets can now be associated with systems or data uses**: a dataset can be referenced at either the system-level or within particular data uses to surface annotated data categories in the data map.  Learn more [here](/docs/docs/tutorials/data-mapping-adding-systems-manually) and [here](/docs/docs/tutorials/data-mapping-data-uses).
