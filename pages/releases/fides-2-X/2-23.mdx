...
- <div class="enterprise"/> **Select vendors**: we've added a new interface to allow customers to select vendors from a list of 1500+ vendors in Fides Compass and have those vendors, with all of their info and data uses, added to the data map. [Learn more](/docs/user-guides/data-mapping/choosing-vendors) 
