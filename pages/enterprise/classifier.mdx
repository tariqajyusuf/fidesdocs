...
The Fides Classifier is an extensible machine-learning classification engine, built on natural language processing and named-entitiy recognition. Fides utilizes these classification strategies to label potential sources of personally identifiable information with Fides' human-readable description taxonomy, and help automate the complex task of identifying PII in your application.

## Running the classifier

Fides represents the schema of a given database as a *dataset,* which allows the contaiend information to be accessed in a standardized, consumable format. When adding a new dataset to your instance of Fides, premium users are provided the option to classify the dataset at the same time it is generated.
