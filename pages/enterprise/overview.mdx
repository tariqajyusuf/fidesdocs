...
<KeyFeatWrap>
  ...
  <KeyFeat title="Data Flow Scanner" link="./dataflow_scanner"   description="Use Fides' automated scanning capabilities to discover and classify systems in your runtime environment."/>
</KeyFeatWrap>