...
<NextSeo
  title="Fides User Guides"
  description="Learn more about the common use cases for Fides here, like processing privacy requests or configuring SaaS applications into your data map."
/>
...
<KeyFeatWrap>
  ...
  <KeyFeat title="Datasets" link="./dev-docs/datasets" description="Learn how you can use datasets to map and manage data for privacy requests across your systems."/>
