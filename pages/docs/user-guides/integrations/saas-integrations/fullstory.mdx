...
<Callout emoji="" type="info">An owned database must be configured to store FullStory data for privacy request processing. To learn how to integrate with a database, please see our guide for [integrating with databases](/user-guides/integrations/databases). </Callout>


In order to [integrate](/user-guides/integrations) with FullStory, you'll need to collect the following information:
