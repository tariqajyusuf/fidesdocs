...
![Login as root](/assets/img/guides/login_as_root.png)
...
![Set Owner Perms](/assets/img/guides/set_owner_permissions.png)
...
![Login as owner](/assets/img/guides/login_as_owner.png)


Navigate to Management > Users and click on `Add New User`. Enter the information for the Privacy Request Approver.

![Create approver user](/assets/img/guides/create_viewer_approver.png)
...
![Set Approver Perms](/assets/img/guides/viewer_approver_role.png)
...
![Viewer Role](/assets/img/guides/viewer_approver_role.png)
...
![Assign Systems](/assets/img/guides/assign_systems.png)
...
![system_list](/assets/img/guides/system_list.png)
