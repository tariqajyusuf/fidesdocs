...
If a request has been **approved**, the data subject will be notified by email. If the request is an [_access_](/docs/tutorials/privacy-requests-glossary#access-request) request, the confirmatiom email will include a download link to retrieve a copy of their personal data.
