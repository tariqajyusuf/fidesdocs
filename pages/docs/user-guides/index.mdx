...
<KeyFeatWrap>
  <KeyFeat title="Privacy Requests" link="/docs/user-guides/privacy-requests" description="Get started with Fides by learning about privacy requests, including how to configure and process them."/>
    <KeyFeat title="Data Mapping" link="/docs/user-guides/data-mapping" description="Get started with data mapping by learning to  add vendors  to your data map and to review system history."/>
        <KeyFeat title="Consent Management" link="/docs/user-guides/consent" description="Cover the basics of consent management, from consent laws to common frameworks like IAB's TCF or the GPC."/>
  <KeyFeat title="Datasets" link="/docs/user-guides/datasets" description="Learn how you can use datasets to map and manage data for privacy requests across your systems."/>
  <KeyFeat title="Integrations" link="/docs/user-guides/integrations" description="Configure and connect your systems, from databases to third-party SaaS applications for privacy requests."/>
