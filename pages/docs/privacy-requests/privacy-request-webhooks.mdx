...
expire when your Redis cache expires represented by `default_ttl_seconds` in your Fides configuration. Read how to set [Fides configuration variables here](/docs/configuration/configuration).
...
The `reply-to-token` expires after a set amount of time, the `privacy_request_delay_timeout` in your Fides configuration. Read how to set [Fides configuration variables here](/docs/configuration/configuration).
