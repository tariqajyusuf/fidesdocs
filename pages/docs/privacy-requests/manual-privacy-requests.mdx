...
Manual privacy requests gather data *outside* of the graph as a first step, and are similar to [privacy request webhooks](../privacy-requests/privacy-request-webhooks).
