...
For more information on policies, see the [privacy request policies](/docs/privacy-requests/privacy-request-graphs) guide.
...
| `policy_key` | Identifies the [privacy request policy](/docs/privacy-requests/privacy-request-graphs) applied to this request. |
...
2. [Configure Emails](/docs/privacy-requests/privacy-request-execution#send-email-notifications) that lets Fides send automated emails to your users.
