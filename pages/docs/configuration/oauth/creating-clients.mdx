...
To create a new client ID and client secret, call `POST /api/v1/oauth/client` using an access token with appropriate scopes as shown in the example below:
