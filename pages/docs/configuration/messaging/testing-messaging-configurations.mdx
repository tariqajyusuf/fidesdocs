...
The `"{{RECIPIENT_EMAIL}}` should be the recipient email address you would like to send a test email to.
...
The `"{{RECIPIENT_PHONE}}` should be the recipient phone number in the format `+19178300000`
