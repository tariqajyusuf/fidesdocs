...
- <div class="enterprise"/> **Customization for all consumer UIs!**: You may now upload a stylesheet to customize consumer-facing UIs like the Privacy Center and Consent Experiences. [Learn more](/docs/tutorials/consent-management-configuration/css-styling)
- <div class="enterprise"/> **CORS domains**: You can now specify CORS domains to add to the Fides allow list directly in the UI. [Learn more](https://docs.ethyca.com/dev-docs/get-started/domains/allowed-domains)
