...
See the the [project requirements](../get-started/requirements) to get started.
...
To learn more about configuring fides, see:
    https://ethyca.github.io/fides/get-started/configuration/
----------
...
## Next steps
For more information on customizing your environment configuration, see the [configuration reference](../configuration/configuration) guide.
