...
<Callout emoji="ⓘ">This guide is designed to get you started with Fides in as few steps as possible. Want to learn about configuration in-depth? Check out the [advanced installation guide here](/docs/get-started/advanced)</Callout>

## Minimum requirements
See the the [project requirements](/docs/get-started/requirements) to get started.
...
For example policies and help getting started, see:
    https://docs.ethyca.com/docs/get-started/quickstart
----------
...
## Next steps
For more information on customizing your environment configuration, see the [configuration reference](/docs/configuration/configuration) guide.
