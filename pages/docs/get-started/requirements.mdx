...
<Callout emoji="ⓘ">Want to quickly experiment with Fides? Use the [demo application](./sample-project) to go from "Zero to DSR Automation" in minutes!</Callout>
...
Read about [configuring storage destinations](/docs/configuration/storage-destinations) here and [configuring the privacy center](/guides/privacy-center) here.
