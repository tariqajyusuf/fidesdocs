...
For full examples of supported Connections, see the [example configurations](/docs/connectors/example-connectors/adobe).
...
Your `instance_key` will become the identifier for the related [Dataset](/docs/databases/datasets). By default, the saas connection config is enabled with write access.
