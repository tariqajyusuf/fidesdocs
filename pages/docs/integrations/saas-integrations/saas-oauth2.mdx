...
- The connector using OAuth2 is configured using the steps for [how to configure a SaaS connector](./overview/#configure-a-saas-connector).
...
![OAuth2 Workflow](/assets/img/saas-connections/oauth2_workflow.png "OAuth2 Workflow")
