...
First you should identify all systems. You can do this by either [manually adding them to your data map](/docs/tutorials/data-mapping-adding-systems-manually), or using [Fides' Detection tools to automatically identify systems](/docs/tutorials/data-mapping-system-detection).
