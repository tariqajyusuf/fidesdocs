...
1. **[Privacy Notices](/docs/tutorials/consent-management-fundamentals/consent-management-privacy-notices)**: the text notification presented to your visitors about your data processing activities.
2. **[Methods of Consent](/docs/tutorials/consent-management-fundamentals/consent-management-consent-methods)**: the type of consent you must collect, depending on the visitors location.
3. **[Privacy Experiences](/docs/tutorials/consent-management-fundamentals/consent-management-privacy-experiences)**: the way the privacy notice and consent are displayed to the visitor on your website.
