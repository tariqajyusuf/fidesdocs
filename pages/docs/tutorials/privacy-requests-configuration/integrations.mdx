...
## Introduction
In this tutorial, you'll add and configure a privacy request integration for a system on the [Data Map.](/docs/tutorials/data-mapping-get-started) By the end of this tutorial, you'll understand the relationship between systems and integrations as well as how to connect, configure, and test an integration.
