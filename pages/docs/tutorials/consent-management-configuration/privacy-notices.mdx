...
After reading this, you'll be familiar with how data uses from the [previous section](/docs/tutorials/consent-management-configuration/data-use-for-consent) automatically generate privacy notices, as well as how to create and manage your own custom privacy notices.
...
Learn more about [privacy notice fundamentals](/docs/tutorials/consent-management-fundamentals/consent-management-privacy-notices) here.
...
You can configure the data uses associated with the privacy notice. Typically, Fides relies on the default data uses but you can add to these at any time. Read about [modifying data uses in the taxonomy](/docs/tutorials/consent-management-configuration/data-use-for-consent) here.
...
The **cookie key** is used to identify the visitors preferences for the specific privacy notice. For example, if a visitor opted out of Data Sales and Sharing, the cookie on their browser would have the value: `data_sales_and_sharing` set to `false`. Learn how to [configure front end consent](/docs/tutorials/consent-management-configuration) here.
