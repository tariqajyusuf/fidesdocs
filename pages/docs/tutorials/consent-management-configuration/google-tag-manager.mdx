...
* Installed `Fides.js` on your web site. Read how to [install fides.js](/docs/tutorials/consent-management-configuration/install-fides) now.
...
<Screenshot img="/assets/img/tutorials/gtm-data-layer-variable-named-with-default-value.png" description="Name the Data Layer Variable" />
