...
<Callout emoji="" type="info">If you're a Fides Enterprise customer, you can use our built-in privacy dictionary, Fides Compass, to pre-populate system info and data use information. Learn more at [Fides Privacy Dictionary](/docs/tutorials/data-mapping-dictionary)</Callout>
...
Next you will learn how to accelerate data entry by using [Fides Compass, a privacy intelligence dictionary](/docs/tutorials/data-mapping-dictionary).