...
<Callout emoji="" type="info">Ethyca recommends using multi-factor authentication (MFA) for identify verification. Fides has built-in subject identity verifiation via MFA.  Learn more about [Subject Identify Verification](/docs/dev-docs/configuration/privacy-requests/subject-identity-verification) here.</Callout>
