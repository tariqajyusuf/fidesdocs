...
Next you will learn how to use [automated system discovery tools](/docs/tutorials/data-mapping-system-detection). and then you will [describe the ways in which you use personal data in your system](/docs/tutorials/data-mapping-data-uses).