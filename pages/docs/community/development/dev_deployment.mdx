...
This guide closely mirrors the [advanced deployment guide](/docs/dev-docs/get-started/advanced) page with some slight differences to account for running in a development environment.
