...
You can do this by implementing your own geolocation via IP detection solution to identify the user’s location and appropriately respect their rights. Or you can use [Fides](https://ethyca.com/book-demo?utm_source=docs-site) to automate this task and adjust jurisdictions as regulations evolve with ease.
