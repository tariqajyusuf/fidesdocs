...
# GDPR Step 03: Correction Requests for GDPR
...
<Callout> Looking for more help with how to ensure personal data is corrected across your systems? Ask a question now in the [Fides Slack Community](https://fid.es/join-slack). </Callout>
