...
<Callout> Need help returning DSR packages in a JSON, CSV, or XML file for data portability requests? Ask how on the [Fides Slack Community](https://fid.es/join-slack). </Callout>

If you want to experience lightning-fast, automated portability requests via the Fides Privacy engineering and intelligence platform, [get in touch now](https://ethyca.com/book-demo?utm_source=docs-site).