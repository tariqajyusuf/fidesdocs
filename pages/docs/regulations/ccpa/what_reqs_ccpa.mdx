...
CCPA as amended by CPRA grants California consumers extra data subject rights and consent rights that your business must enable. This section goes over these rights in more detail. 
...
### 7. CPRA introduces data minimization
    ...
    The CPRA introduces the concept of data minimization and storage limitation. If you're familiar with the GDPR you may already be familiar with this. The CPRA requires that businesses only collect personal information that is reasonably necessary, and that a business should not store data for longer than is necessary.
