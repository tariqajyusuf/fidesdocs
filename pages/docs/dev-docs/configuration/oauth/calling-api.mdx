...
* A valid `access_token` created from a valid `client_id` and `client_secret`. Read how to [generate access tokens](/docs/dev-docs/configuration/oauth/generating-tokens) here.
