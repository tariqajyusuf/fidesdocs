...
The placeholders are sourced from the values defined in the [`connector_params`](/dev-docs/configuration/integrations/saas-integrations/saas-config#integration-params) of your SaaS config.
...
- The connector using OAuth2 is configured using the steps for [how to configure a SaaS connector](/dev-docs/configuration/integrations/saas-integrations/saas-config).
