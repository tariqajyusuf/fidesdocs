...
The placeholders are sourced from the values defined in the [`connector_params`](/docs/dev-docs/configuration/integrations/saas-integrations/saas-config#integration-params) of your SaaS config.
...
- The connector using OAuth2 is configured using the steps for [how to configure a SaaS connector](/docs/dev-docs/configuration/integrations/saas-integrations/saas-config).
