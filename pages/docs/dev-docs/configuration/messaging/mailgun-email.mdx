...
For detailed step-by-step instructions on configuring the template, please visit the [configure email style customization](/docs/user-guides/privacy-requests/configure-email/email-style) section. Below is a brief summary on making the template.
