...
This process will require having the Dataset YAML file locally. If using Fides Cloud, you will need to follow the [steps to pull Datasets locally](/docs/user-guides/datasets/annotate-datasets).
