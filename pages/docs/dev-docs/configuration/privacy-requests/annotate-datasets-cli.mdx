...
<<<<<<< HEAD:pages/docs/dev-docs/configuration/privacy-requests/annotate-datasets-cli.mdx
This process will require having the Dataset YAML file locally. If using Fides Cloud, you will need to follow the [steps to pull Datasets locally](/docs/tutorials/privacy-requests-configuration/privacy-requests-dataset-annotation#pull-the-generated-dataset-locally).
=======
This process will require having the Dataset YAML file locally. If using Fides Cloud, you will need to follow the [steps to pull Datasets locally](/user-guides/datasets/annotate-datasets).
>>>>>>> main:pages/dev-docs/configuration/privacy-requests/annotate-datasets-cli.mdx
