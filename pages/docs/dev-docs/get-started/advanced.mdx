...
## Next steps
Now that Fides is up and running, you're ready to get started with [privacy request automation](/docs/tutorials/privacy-requests-get-started) and [data mapping](/docs/tutorials/data-mapping-get-started)!
