...
<Callout emoji="">**Note:** Passwords require 8 characters minimum, with atleast one number, one capital letter and one symbol.</Callout>
...
```console
$ fides user create -u newuser -p pA$$w0rd
Loaded config from: .fides/fides.toml
User: 'newuser' created and assigned permissions.
```
