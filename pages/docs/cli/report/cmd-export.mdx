...
> **Hands-on:** Try the [Building and Exporting Reports in Fides](#LINK) tutorials.
...
* <span class="nx-absolute -nx-mt-20" id="datamap"></span>[```datamap```](#datamap) - Export a datamap from Fides. The default export format is Excel, although other options are possible with the option flags below.
        ...
        * <span class="nx-absolute -nx-mt-20" id="csv"></span>[```--csv```](#csv) - Exports the report in CSV format intead.
...
## Example: Export a full data map to a speecified location
