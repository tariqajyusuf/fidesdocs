...
> **Hands-on:** Try the [Fides: Get Started](/docs/dev-docs/get-started) tutorials.  For more in-depth details on the ```scan``` command, check out the [Annotation Coverage tutorial](/docs/user-guides/datasets/annotate-datasets).
...
In this example, ```pg-credentials``` is the key that represents the credentials in the configuration file. For more in-depth details on using configuration files, check out the [Fides Configuration tutorial](/docs/dev-docs/configuration/configuration).
...
In this example, ```aws-credentials``` is the key that represents the credentials in the configuration file. For more in-depth details on using configuration files, check out the [Fides Configuration tutorial](/docs/dev-docs/configuration/configuration).
...
In this example, ```okta-credentials``` is the key that represents the credentials in the configuration file. To learn more about configuration files, check out the [Fides Configuration tutorial](/docs/dev-docs/configuration/configuration). 
