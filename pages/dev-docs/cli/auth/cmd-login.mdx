...
<Callout emoji="">**Note:** The username and password provided must be an existing, authorized user for Fides. If you have not created at least one user for Fides already, you must complete this step first. For details on creating users, see the [Creating Fides Users](/docs/dev-docs/cli/auth/cmd-create) guide.</Callout>
