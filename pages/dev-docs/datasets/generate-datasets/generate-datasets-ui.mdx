...
In this guide you will learn how to generate a Fides dataset via the Fides Control admin UI. Read more about [datasets here](/dev-docs/datasets/) or read how to [generate datasets via the Fides CLI here](generate-datasets-cli).
