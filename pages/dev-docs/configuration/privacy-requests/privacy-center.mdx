...
<Screenshot img="/assets/img/configuration/configuration-privacy-center-default.gif" description="The default privacy center" />
...
| `policy_key` | A key that refers to the [policy](/docs/dev-docs/configuration/policies/request-policies) that will be used. |
...
| `policy_key` | A key that refers to the [policy](/docs/dev-docs/configuration/policies/request-policies) that will be used for this action. |
