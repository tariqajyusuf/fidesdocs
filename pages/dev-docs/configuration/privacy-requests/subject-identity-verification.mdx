...
You may also customize the content of the email that is sent for this purpose. See our guide for [configuring email content](/docs/user-guides/privacy-requests/configure-email) to learn more

### Configure a messaging service
The available messaging services for Subject Identity Verification are:
* [Mailgun for email](/docs/dev-docs/configuration/messaging/mailgun-email)
* [Twilio for email](/docs/dev-docs/configuration/messaging/twilio-email)
* [Twilio for SMS](/docs/dev-docs/configuration/messaging/twilio-sms)
...
To set this in the Fides Configuration file, please locate the variable within the appropirate `fides.toml` file. To learn more about where to find this file, please see the [Fides Configuration](/docs/dev-docs/configuration/configuration) guide.  
