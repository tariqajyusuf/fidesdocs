...
![Example tables](/assets/img/resources/traversal_tables.png "Example tables")
...
For the first step, Fides uses the concept of an `identity`. In the Fides [Dataset](/docs/dev-docs/configuration/integrations/database-integrations/datasets) specification, any field may be marked with an `identity` notation:
...
![Example graph](/assets/img/resources/traversal_graph.png "Example graph")
