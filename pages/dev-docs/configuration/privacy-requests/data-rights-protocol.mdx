...
A [DRP action](https://github.com/consumer-reports-digital-lab/data-rights-protocol#301-supported-rights-actions) may be defined when creating or editing a [policy](/dev-docs/configuration/policies/request-policies). These actions associate a Fides privacy request policy with a DRP-standardized protocol for receiving and processing Data Rights Requests.
