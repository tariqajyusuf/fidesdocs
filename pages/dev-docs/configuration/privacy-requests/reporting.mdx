...
See the [manual data guides](/user-guides/integrations/database-integrations/datasets#resume-a-paused-access-privacy-request) for more information on resuming a paused access request.
...
A confirmation of the masked records count should be uploaded to the `resume_endpoint`. See the [manual data guides](/user-guides/integrations/database-integrations/datasets#resume-a-paused-access-privacy-request) for more information on resuming a paused erasure request.
