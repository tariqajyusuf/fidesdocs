...
An webhook is an HTTPS callback that you've defined on an [execution policy](/policies/request-policies) to call an external REST API endpoint either *before* or *after* a privacy request executes.
