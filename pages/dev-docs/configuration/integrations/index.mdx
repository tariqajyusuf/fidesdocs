...
A _Connection_ links your owned databases and [third-party applications](/user-guides/integrations/) to Fides, allowing Fides to execute privacy requests against your collections and fields.
