...
Ensure you have created a [Connection](/user-guides/integrations) for the datastore you would like to map. The Dataset defined by the following process should be [linked to the Connection](/user-guides/datasets/link-datasets).
...
To add a Manual Dataset, first create a [Manual Connection](/dev-docs/configuration/integrations/database-integrations/datasets#configure-a-manual-dataset). The following Manual Dataset can then be added to the new ConnectionConfig:
