...
These pagination strategies allow Fides to incrementally retrieve content from APIs. APIs can vary in the way subsequent pages are accessed so these configurable options aim to cover a majority of common use cases.
