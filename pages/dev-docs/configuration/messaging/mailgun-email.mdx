...
For detailed step-by-step instructions on configuring the template, please visit the [configure email style customization](/user-guides/privacy-requests/configure-email/style-customizatons.mdx) section. Below is a brief summary on making the template.
