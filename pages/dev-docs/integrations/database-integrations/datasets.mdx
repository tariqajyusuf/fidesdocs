...
Ensure you have created a [Connection](/docs/databases/database-connections) for the datastore you would like to map. The Dataset defined by the following process should be [associated to the Connection](/docs/databases/database-connections#associate-a-dataset).
...
To add a Manual Dataset, first create a [Manual Connection](/docs/databases/database-connections#examples). The following Manual Dataset can then be [added to](/docs/databases/database-connections#associate-a-dataset) the new ConnectionConfig:
