...
| Link the Dataset | Connect the dataset to the System to enable privacy requests against your database. | [Link Datasets](/user-guides/datasets/link-datasets) |
...
| Step | Description | Notes |
| --- | --- | --- |
| Integrate Third Party System | Fides comes pre-configured with SaaS connectors that integrate into third party systems. | [Example: Stripe - Configuring the integration](/dev-docs/integrations/saas-integrations/example-configs/stripe) |
| Test your integration | Test your request via the Fides Privacy Center or DSR client, and approve it in the Fides administrative console. | [Submitting a Request](/user-guides/privacy-requests/submit-requests)<br></br><br></br>[Approving a Request](/user-guides/privacy-requests/manage-requests) |
