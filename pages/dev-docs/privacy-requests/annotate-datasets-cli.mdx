...
This process will require having the Dataset YAML file locally. If using Fides Cloud, you will need to follow the [steps to pull Datasets locally](/dev-docs/privacy-requests/datasets/annotate-datasets).
