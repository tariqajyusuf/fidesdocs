...
You can specify the data category for each field of a collection in a Fides dataset. Read about [Fides dataset structures here](/dev-docs/privacy-requests/datasets/structure).
To learn about [generating datasets read the guide here](/dev-docs/privacy-requests/datasets/generate-datasets).
