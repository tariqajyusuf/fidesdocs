...
<Callout emoji="" type="info">This guide is designed to get you started with Fides running on your computer in as few steps as possible using a local sample project. Want to learn about configuration in-depth? Check out the [basic installation](/docs/dev-docs/get-started/installation) or [advanced installation guide here](/docs/dev-docs/get-started/advanced)</Callout>
...
To deploy and configure Fides in your own infrastructure, see the [Pdetailed installation](/docs/dev-docs/get-started/advanced) and use the available [Helm chart](/docs/dev-docs/get-started/advanced#using-helm-recommended-if-using-kubernetes) or [Terraform modules](/docs/dev-docs/get-started/advanced#using-terraform) here.
...
<Callout type="info" emoji="">If running `fides deploy` as part of a local fides development environment, refer to the [local documentation](/docs/community/development/dev_deployment) instead.</Callout>
...
* The Fides Control admin UI for managing [privacy requests](/docs/docs/tutorials/privacy-requests-get-started)
* The Fides [Privacy Center](/docs/dev-docs/configuration/privacy-requests/privacy-center) for submitting requests
...
## Next steps
Congratulations! You've just run an entire privacy request in under 5 minutes! Fides offers many more tools help take control of your data privacy. To find out more, you can run a privacy request on [your own infrastructure](/docs/docs/tutorials/privacy-requests-get-started), discover [data mapping](/docs/docs/tutorials/data-mapping-get-started), or learn about the [Fides Taxonomy](https://ethyca.github.io/fideslang/).