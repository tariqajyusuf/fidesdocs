...
This page contains all of the DNS verification records required to verify that you have ownership of your domain and to correctly configure email sending. These records must be added to your DNS server.
