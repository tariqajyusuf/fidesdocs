...
Learn more about [subject identify verification](/tutorials/privacy-requests/privacy-requests-workflow/privacy-requests-submitting-requests#subject-identity-verification) here.
...
<Screenshot img="/docs/assets/img/configuration/email-dns-verification.png" description="Email domain name verification - example DNS records" />
