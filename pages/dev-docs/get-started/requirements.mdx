...
<Callout emoji="ⓘ">Want to quickly experiment with Fides? Use the [demo application](/dev-docs/get-started) to go from "Zero to DSR Automation" in minutes!</Callout>
