...
<Callout emoji="" type="info">Want to quickly experiment with Fides? Use the [demo application](/dev-docs/get-started) to go from "Zero to DSR Automation" in minutes!</Callout>
...
Read about [configuring storage destinations](/dev-docs/configuration/privacy-requests/storage-destinations) here and [configuring the privacy center](/dev-docs/configuration/privacy-requests/privacy-center) here.
