...
See the the [project requirements](/docs/dev-docs/get-started/requirements) to get started.
...
## Next steps
For more information on customizing your environment configuration, see the [configuration reference](/docs/dev-docs/configuration/configuration) guide.

Now that Fides is up and running, you're ready to get started with [DSR automation](/docs/docs/tutorials/privacy-requests-get-started) and [data mapping](/docs/docs/tutorials/data-mapping-get-started)!