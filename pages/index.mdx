...
<CtaTileWrap>
  ...
  <CtaTile title="Install" link="docs/get-started/quickstart"/>
</CtaTileWrap>
...
Ready to get started? Use our [sample application](docs/get-started/quickstart) to go from 'Zero to DSR Automation' in minutes!
