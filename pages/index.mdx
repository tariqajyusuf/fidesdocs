...
<CtaTileWrap>
  ...
  <CtaTile title="Install" link="docs/get_started/quickstart"/>
</CtaTileWrap>
...
Ready to get started? Use our [sample application](docs/get_started/quickstart) to go from 'Zero to DSR Automation' in minutes!
