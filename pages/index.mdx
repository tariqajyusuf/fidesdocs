...
<GetStartedWrap>
  <GetStarted title="DSR Automation" link="./dsr_quickstart/basic_setup"  description="According to all known laws of aviation"/>
  <GetStarted title="Data Mapping" link="https://twitter.com/cillian"  description="According to all known laws of aviation" />
  <GetStarted title="Managing Consent" link="https://twitter.com/cillian"   description="According to all known laws of aviation"/>
  <GetStarted title="DSR Automation Demo Project" link="/sample_project"   description="According to all known laws of aviation"/>
</GetStartedWrap>
